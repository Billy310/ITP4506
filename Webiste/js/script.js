$(document).ready(function () {
	...
	$('#add1').click(function () {
		...
		setTimeout(function () {
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + productImage + "' alt='' /></div><span>" + productName + "</span><strong>HKD$" + price + "</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";
